          ...
          <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-3 gap-3 p-4 bg-gray-50 rounded-xl border border-gray-200">
                {[
                  {l:'Consultations non payées', v:selectedEarning.stats.unpaidConsultations, c:'text-gray-900'},
                  {l:'Montant suggéré',           v:`${selectedEarning.stats.amountDue} XOF`,  c:'text-green-600'},
